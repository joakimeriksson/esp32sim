...
const bins={baseline:root+'/baseline/target/release/esp32sim',candidate:root+'/candidate/target/release/esp32sim'};
...
const out=root+'/runs/native-pocket-tank';fs.mkdirSync(out);
