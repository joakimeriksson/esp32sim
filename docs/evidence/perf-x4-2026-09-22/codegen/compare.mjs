...
console.log(JSON.stringify({beforeSha256:a.sha256, afterSha256:b.sha256, beforeFunctions:a.bodies.length, afterFunctions:b.bodies.length, changedBodies:changes, sections:a.sections.map((v,i)=>({id:v.id,beforeBytes:v.size,afterBytes:b.sections[i]?.size,identical:v.sha256===b.sections[i]?.sha256}))},null,2));
